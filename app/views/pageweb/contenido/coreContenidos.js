var app = angular.module('MainAppContenidos', ["ui.bootstrap"]);

function mainControllerContenidos($scope, $http) {
    $scope.newContenido = {};
    //$scope.items = {};
   ...
   /* $http.get('/api/contenido', { responseType: "arraybuffer" }).success(function (data) {
        $scope.items = data;
    }).error(function (data) {
        console.log('Error: ' + data);
    });*/

    $("#contenidos #checkall").click(function () {
        if ($("#contenidos #checkall").is(':checked')) {
            $("#contenidos input[type=checkbox]").each(function () {
    ...
    */
    ...
    $scope.selectContenido = function (item) {
        ...
        // Obtenemos todos los datos de la base de datos para cargar la lista inicial
        /*$http.get('/api/contenidos/' + $scope.RegionPage + '/' + $scope.RegionRow).succes
            $scope.items = data;
        }).error(function (data) {
            console.log('Error: ' + data);
        });*/
    ...
    $scope.GetAttributesByRegion = function (regionFrwdPageButtonClick, regionBckPageButtonClick) {
        ...
        $http.get('/api/contenido/' + $scope.RegionPage + '/' + $scope.RegionRow).success(function (data) {
            $scope.Regions = data;
