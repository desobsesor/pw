var app = angular.module('MainAppNoticias', ["ui.bootstrap"]);

function mainControllerNoticias($scope, $http) {
    $scope.newNoticia = {};
    $scope.items = [];
    ...
    $scope.generarExelNoticias = function(){

        $http.get('/api/noticiasd').success(function (data) {
            //$scope.items = data;
            console.log("data");
            //console.log(data);
            //$scope.Regions = data;
    ...
    $scope.buscarNoticiaPorDocumento = function () {
        console.log("req.params.documento:$" + $scope.newNoticia.documento);
        $http.get('/api/noticia/' + $scope.newNoticia.documento, $scope.newNoticia)
            .success(function (data) {
                if (data.length > 0) {
                    ...
                    //console.log("$scope.newNoticia despues");
                    //console.log($scope.newNoticia);
                    $scope.sexos[0] = $scope.newNoticia.sexo;
                    $scope.tipoDocumento[0] = $scope.newNoticia.tipoDocumento;
                    $scope.estadoCivil[0] = $scope.newNoticia.estadoCivil;
                    $scope.nivelEducativo[0] = $scope.newNoticia.nivelEducativo;
                }
                //$scope.newNoticia = {}; 
    ...
    // Función para editar los datos de un item
    $scope.publicarNoticia = function (newNoticia) {
        Swal({
            title: 'Esta seguro?',
            ...
            if (result.value) {
                $http.put('/api/noticia/' + newNoticia._id + '/activo/' + true)
                    .success(function (data) {
                        $scope.newNoticia = {}; // Borramos los datos del formulario
                        $scope.items = data;
                        $scope.Regions = data;
                        ...
                        toast({
                            type: 'info',
                            title: '<span style="text-align:left;">Noticia activada exitosamente para aparecer en la pagina principal!</span>'
                        });
                        //$scope.tab = 1;
                    })
                    .error(function (data) {
    ...
    // Función para editar los datos de un item
    $scope.inactivarEnPaginaPrincipal = function (newNoticia) {
        Swal({
            title: 'Esta seguro?',
            text: "Tranquilo, esta desición se puede revertir!",
            type: 'info',
            ...
            if (result.value) {
                $http.put('/api/noticiai/' + newNoticia._id + '/enpaginaprincipal/' + true)
                    .success(function (data) {
                        $scope.newNoticia = {}; // Borramos los datos del formulario
                        $scope.items = data;
                        $scope.Regions = data;
                        ...
                        toast({
                            type: 'info',
                            title: '<span style="text-align:left;">Noticia inactivada exitosamente para aparecer en la pagina principal!</span>'
                        });
                        //$scope.tab = 1;
                    })
                    .error(function (data) {
    ...
    // Función para editar los datos de un item
    $scope.activarEnPaginaPrincipal = function (newNoticia) {
        Swal({
            title: 'Esta seguro?',
            text: "Tranquilo, esta desición se puede revertir!",
            type: 'info',
            ...
            if (result.value) {
                $http.put('/api/noticiac/' + newNoticia._id + '/enpaginaprincipal/' + true)
                    .success(function (data) {
                        $scope.newNoticia = {}; // Borramos los datos del formulario
                        $scope.items = data;
                        $scope.Regions = data;
    ...
    $scope.borrarNoticia = function (newNoticia) {
        ...
        Swal({
            ...
            if (result.value) {
                ...
                $http.delete('/api/noticia/' + newNoticia._id)
                    .success(function (data) {
                        $scope.newNoticia = {};
                        $scope.items = data;
                        $scope.Regions = data;
    ...
    //$http.get('/api/noticia', { responseType: "arraybuffer" }).success(function (data) {



    $("#noticias #checkall").click(function () {
        if ($("#noticias #checkall").is(':checked')) {
            $("#noticias input[type=checkbox]").each(function () {
    ...
    $scope.GetAttributesByRegion = function (regionFrwdPageButtonClick, regionBckPageButtonClick) {
        ...
        $http.get('/api/noticia').success(function (data) {
            $scope.items = data;
        ...
        console.log("entro al metodo de paginación");
        ...
        $http.get('/api/noticia/' + $scope.RegionPage + '/' + $scope.RegionRow).success(function (data) {
            $scope.Regions = data;
    ...
    */
    ...
    $scope.selectNoticia = function (item) {
        ...
        // Obtenemos todos los datos de la base de datos para cargar la lista inicial
        /*$http.get('/api/noticias/' + $scope.RegionPage + '/' + $scope.RegionRow).succes
            $scope.items = data;
        }).error(function (data) {
            console.log('Error: ' + data);
        });*/
